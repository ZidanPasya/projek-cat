...
@section('content')
            ...
            <div class="ibox-content">
                ...
                <div class="main">
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="right-side" style="margin-right: 300px;">
                            <p>Steps 1/2</p>
                            <h2>Memilih paket yang sudah ada</h2>
                            <p>Tolong pilih paket yang akan dibuat ulang</p>
                            <hr class="mt-4 mb-4" style="border: 1px solid #A8BFD1">
                            <p>Pilih salah satu paket yang akan dibuat ulang</p>
                            ...
                            <button id="buatPaket">Selanjutnya</button>
    ...
    <script>
        var PaketLama = document.getElementById("buatPaket");
        PaketLama.addEventListener("click", function() {
            window.location.href = "pilih_soal_paket";
        });
    </script>
