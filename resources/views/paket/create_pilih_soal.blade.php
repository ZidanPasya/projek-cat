                        ...
                        <div class="right-side">
                            ...
                            <div class="dropdown-filter pb-4">
                                <select id="kementerian">
                                    <option>matematian</option>
                                    <option>tes potensi akademik dan sosial dan agama</option>
                                    <option>matematian</option>
                                    <option>matematian</option>
                                </select>
                            </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="button-group">
                                                ...
                                                <button class="custom-button-topik"><span>Kompetensi Dasar</span></button>
                                            </div>
                                            <div class="content-question">
                                                <p style="font-size: 12px; "> Itu pun banyak ilmuwan
                                                    terapan yang meminjam ilmu dasar atau ilmu terapan lain sehingga
                                                    terbentuk program multidisiplin seperti arsitektur yang dijodohkan
                                                    dengan antropologi atau arkeologi, akuntansi dengan ilmu keuangan.</p>
                                            </div>
                            ...
                            <button id="simpanPaket">Selanjutnya</button>
