        ...
        <div class="ibox-content">
            ...
            <div class="main">
                ...
                <div class="main-wrapper">
                    ...
                    <div class="right-side" style="width: 93%; margin-right: 300px;">
                        <p>Steps 1/2</p>
                        ...
                        <input class="form-control" type="text" aria-label="Text input" id="namaPaket">
                        <p class="pt-4">Isikan jumlah soal dalam satu paket</p>

                        <div class="input-group pb-4">
                            <input class="form-control" type="number" aria-label="Text input" id="jumlahSoal">
                        </div>
...
<script>
      var Paketbaru = document.getElementById("buatPaket");
      Paketbaru.addEventListener("click", function() {
